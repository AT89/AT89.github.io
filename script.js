...
$("#instagram")
.on("click", function(e){
  $("#contentBlog").first().html("Instagram Gallery feed.<br> Using Instagram sandbox API and  slick.js (the best carousel library) <br><br><a class='go' href='https://at89.github.io/instagramfeed'>App</a> | <a class='go' href='http://kenwheeler.github.io/slick/'>Slick</a> | <a class='go2' href='https://github.com/AT89/instagramfeed'>Github</a> ")
});
